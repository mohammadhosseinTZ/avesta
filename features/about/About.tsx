...
function About() {
    return (
        <div className="container flex flex-col md:flex-row-reverse justify-between pb-[50px]">
            <div className="relative w-full md:w-[40%] aspect-[2/2] my-[20px] md:my-[0px] md:aspect-[2/2.5]"><Image src={"/assets/aboutUsImage.png"} alt="about" fill /></div>
            <div className="w-full md:w-[50%]">
                <h4 className='text-white-color text-[20px] md:text-[20px] font-bold text-right leading-9 md:leading-11.5 '>درباره <span className="text-orange">اَوستا</span> هوش‌یار</h4>
